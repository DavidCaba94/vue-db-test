<template>
  <div class="contenedor-nueva-ruta">
    ...
    <div class="formulario-ruta">
        ...
        <div class="btn-guardar" @click="actualizarRuta()">Guardar</div>
    ...
    methods: {
        ...
        verificarUsuarioRuta:function() {
            if(this.usuario.id != this.ruta.id_usuario){
                ...
                newmap.flyTo(new L.LatLng(this.latSeleccionada, this.longSeleccionada), 15);
        ...
        actualizarRuta:function() {
            if(this.comprobarCamposObligatorios()){
                ...
                axios.post(url, {
                    ...
                    if(response.status == 200){
                        this.$router.replace('/ruta/'+this.idRuta);
                    } else {
                        this.$router.replace('/error');
                    }
                });
